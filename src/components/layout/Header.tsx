...
const Header: React.FC = () => {
  ...
  return (
    <header className="bg-white/95 backdrop-blur-sm shadow-soft border-b border-neutral-200 dark:bg-slate-950/95 dark:border-slate-800 sticky top-0 z-50">
              ...
              {isAuthenticated ? (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-xl border border-neutral-200 bg-white px-4 py-2 text-sm font-medium text-neutral-700 hover:bg-neutral-50 transition-all duration-200 shadow-soft hover:shadow-medium dark:border-slate-700 dark:bg-slate-800 dark:text-neutral-300 dark:hover:bg-slate-700"
                  >
